  ...
  return (
    <form className={classNames(className, scss._)}>
      <Field className={scss.header}>
        <div className={scss.caption}>Мы стремимся стать лучше для Вас!</div>
        <p>
          Загрузите фотографию своего элемента и помогите нам совершествовать
          Вязаный Конструктор
        </p>
      </Field>
      <Field
      ...
      <Field label="Описание" id="102" labelClassName={scss.label}></Field>
      <Field>
        <DropInput />
      </Field>
